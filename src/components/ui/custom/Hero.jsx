          ...
          <div className="flex  flex-col md:flex-row  items-center gap-8 max-w-5xl w-full md:mx-40 ">
            ...
            <div className="w-full sm:w-[300px] md:w-[500px] lg:w-[700px]">
              <p className="mb-4">
                ...
                advanced AI and designed to make every journey seamless,
                exciting, and tailored just for you! TRAVEL-GPT understands your
                travel needs, whether you’re planning a spontaneous weekend
                getaway or a carefully budgeted adventure for two.
              </p>
              <p className="mb-4">
                With TRAVEL-GPT, you’ll receive a meticulously crafted travel
                plan complete with handpicked hotel options, full of essential
                details like pricing, location, ratings, and nearby points of
                interest. Each itinerary is designed with care, including daily
                schedules, the best times to visit attractions, travel routes,
                ticket information, and much more, so your journey flows as
